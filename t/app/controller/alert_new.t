...
subtest 'test notification preferences' => sub {
    ...
    FixMyStreet::override_config {
        ...
        foreach (
            ...
            like $text, qr{Your report has had an update; please visit http://www.example.org/report/\d+ to view\. http://www.example.org/A/[A-Za-z0-9]+ to stop\.}, 'text looks okay';
            @{$twilio->texts} = ();
        }
    };
