...
subtest "sends branded alert emails" => sub {
    ...
    like $text_content, qr{Your report has had an update; please visit http://hackney.example.org/report/\d+ to view\. http://hackney.example.org/A/[A-Za-z0-9]+ to stop\.};
